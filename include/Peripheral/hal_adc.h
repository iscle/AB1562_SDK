 ...
 *       hal_adc_get_data_polling(HAL_ADC_CHANNEL_AIO_0, &adc_data);//Retrieve ADC data for channel 0.
...
typedef enum {
    ...
    HAL_ADC_AVERAGE_256 = 7,				/**< Average number 2s56 */
 ...
 * @param[raw_data] channel is the raw data of the channel.
