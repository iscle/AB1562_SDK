...
typedef enum {
    ...
    HAL_UART_EVENT_OVERRUN_ERROR = 4,           /**< Indicates if there is an overrun line error. */
    HAL_UART_EVENT_PARITY_ERROR = 5,            /**< Indicates if there is a parity error. */
    HAL_UART_EVENT_FRAMING_ERROR = 6,           /**< Indicates if there is a framing error. */
    HAL_UART_EVENT_BREAK_INTR = 7,              /**< Indicates if there is a break error. */
