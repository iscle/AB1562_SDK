...
*       hal_pinmux_set_function(HAL_GPIO_2, HAL_GPIO_2_SPI_MST0_CS0);// Set the pin to be used as CS signal of SPI.
*       hal_pinmux_set_function(HAL_GPIO_5, HAL_GPIO_5_SPI_MST0_SCK);// Set the pin to be used as SCK signal of SPI.
*       hal_pinmux_set_function(HAL_GPIO_4, HAL_GPIO_4_SPI_MST0_MOSI);// Set the pin to be used as MOSI signal of SPI.
*       hal_pinmux_set_function(HAL_GPIO_3, HAL_GPIO_3_SPI_MST0_MISO);// Set the pin to be used as MISO signal of SPI.
...
*    hal_gpio_init(HAL_GPIO_5);
*    hal_pinmux_set_function(HAL_GPIO_5, HAL_GPIO_5_SPI_MST0_SCK);
*    // Call #hal_gpio_set_driving_current() to set the proper driving current for this SPI pin.
*    hal_gpio_set_driving_current(HAL_GPIO_5, HAL_GPIO_DRIVING_8MA);
