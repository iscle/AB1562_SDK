...
typedef enum {
    HAL_GPIO_DRIVING_CURRENT_1MA    = 0,        /**< Defines GPIO driving current as 1mA.  */
    HAL_GPIO_DRIVING_CURRENT_2MA    = 1,        /**< Defines GPIO driving current as 2mA.  */
    HAL_GPIO_DRIVING_CURRENT_4MA    = 2,        /**< Defines GPIO driving current as 4mA.  */
    HAL_GPIO_DRIVING_CURRENT_8MA    = 3,        /**< Defines GPIO driving current as 8mA.  */
    HAL_GPIO_DRIVING_CURRENT_12MA   = 4,        /**< Defines GPIO driving current as 12mA. */
    HAL_GPIO_DRIVING_CURRENT_16MA   = 5,        /**< Defines GPIO driving current as 16mA. */
    HAL_GPIO_DRIVING_CURRENT_18MA   = 6,        /**< Defines GPIO driving current as 18mA. */
    HAL_GPIO_DRIVING_CURRENT_20MA   = 7,        /**< Defines GPIO driving current as 20mA. */
...
/** @brief This enum defines gpio used for. */
typedef enum {
    HAL_PINMUX_DEFAULT = 0,
    HAL_PINMUX_PWM1 = 1,
    HAL_PINMUX_PWM2,
    HAL_PINMUX_PWM3,
    HAL_PINMUX_PWM4,
    ...
    HAL_PINMUX_LED5,
    HAL_PINMUX_SDIO_LED,
    HAL_PINMUX_CLK_XO32k,
    HAL_PINMUX_CLK_XO16m,
    HAL_PINMUX_CLK_RCO128_64k,
    HAL_PINMUX_PER_CLK_24m,
    HAL_PINMUX_CLK_XO16m_divided_by_N,
    HAL_PINMUX_I2S_MCLK,
    HAL_PINMUX_UART_NRTS,
    HAL_PINMUX_SPDIF_TXO,
    HAL_PINMUX_DMIC_CLK,
    HAL_PINMUX_MDSP_UART_TX,
    HAL_PINMUX_CS_1,
    HAL_PINMUX_CS_2,
    HAL_PINMUX_CS_3,
    HAL_PINMUX_SDIO_BUS_PWR_CTL,
    HAL_PINMUX_I2S0_SDO1,
    HAL_PINMUX_I2S0_SDO2,
    HAL_PINMUX_UART2_TX,
