...
/**
 * @brief  This function sets the PWM prescale configuration.
 * @param[in]  pwm_channel is the PWM channel number. For more details about the parameter, please refer to #hal_pwm_channel_t.
 * @param[in]   prescale_value is  PWM source clock prescale value.
 * @return    To indicate whether this function call is successful or not.
 *            If the return value is #HAL_PWM_STATUS_OK, the operation completed successfully.
 *            If the return value is #HAL_PWM_STATUS_INVALID_PARAMETER, a wrong parameter is given. The parameter needs to be verified.
 * @par       Example
...
hal_pwm_status_t hal_pwm_set_perscale(hal_pwm_channel_t pwm_channel, uint16_t prescale_value);



/**
 * @brief  This function gets the PWM prescale configuration.
 * @param[in]  pwm_channel is the PWM channel number. For more details about the parameter, please refer to #hal_pwm_channel_t.
 * @param[out]  prescale_value is  PWM source clock prescale value.
 * @return    To indicate whether this function call is successful or not.
 *            If the return value is #HAL_PWM_STATUS_OK, the operation completed successfully.
 *            If the return value is #HAL_PWM_STATUS_INVALID_PARAMETER, a wrong parameter is given. The parameter needs to be verified.
 * @par       Example
...
hal_pwm_status_t hal_pwm_get_perscale(hal_pwm_channel_t pwm_channel, uint16_t *prescale_value);
