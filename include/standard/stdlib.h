...
/*!
     ...
     @defgroup PAGE_STDLIB stdlib.h
     @{
        @page PAGE_API_STDLIB stdlib.h
        stdlib.h has APIs related to stdlib.

*/

/*!
 *@file   stdlib.h
 *@brief  Defines airoha standard library
 *
 */
...
VOID* iram_malloc(U32 size);
VOID  iram_free(VOID* ptr);
