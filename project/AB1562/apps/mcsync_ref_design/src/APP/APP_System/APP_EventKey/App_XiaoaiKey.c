...
{
	{NULL},	//XIAOAI_KEY_EVENT_KEY_FUNC_2
	{NULL}, //XIAOAI_KEY_EVENT_KEY_SPEECH_START
	{NULL}, //XIAOAI_KEY_EVENT_KEY_FUNC_1
};
...
void APP_Xiaoai_ProcessKeyEvent(BD_ADDR_T *pBdAddr, U16 keyIndex)
{
	switch(keyIndex)
	{
		case XIAOAI_KEY_EVENT_KEY_FUNC_2:
			APP_Xiaoai_Key_FUNC2(pBdAddr);
			break;
		case XIAOAI_KEY_EVENT_KEY_SPEECH_START:
			APP_Xiaoai_Key_SpeechStart(pBdAddr);
			break;
		case XIAOAI_KEY_EVENT_KEY_FUNC_1:
			APP_Xiaoai_Key_FUNC1(pBdAddr);
			break;
		default:
			break;
	}
...
void APP_Xiaoai_Key_FUNC2(BD_ADDR_T *pBdAddr)
{
    UNUSED(pBdAddr);
}
...
void APP_Xiaoai_Key_FUNC1(BD_ADDR_T *pBdAddr)
{
	UNUSED(pBdAddr);
}

BOOL APP_Xiaoai_SpeechStop(BD_ADDR_T *pBdAddr)
{
