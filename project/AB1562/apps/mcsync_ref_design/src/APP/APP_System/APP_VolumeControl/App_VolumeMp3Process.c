...
void APP_VolMp3_VolumeUpDown(BOOL isVolumeUp)
{
	...
	{
		APP_VolProcess_Beep(soundLevel, AUDIO_DEVICE_MP3, TRUE);
	}
	else
	{
...
void APP_VolMp3_SyncBeep(void)
{
	APP_VolProcess_Beep(APP_VolMp3_GetCurrentSoundLevel(), AUDIO_DEVICE_MP3, FALSE);
}
