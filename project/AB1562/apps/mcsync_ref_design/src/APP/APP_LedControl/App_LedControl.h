...
typedef struct
{
	...
	LED_AWS_CTL_STRU	awsCtl[MCSYNC_LED_SET_ACTION_NUM];
	LED_ACTION_CTL_STRU	action;
    U8                  currentType;
}LED_CTRL_STRU;
