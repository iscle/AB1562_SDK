...
enum
{
	...
	AUDIO_DEVICE_LINK_END = AUDIO_DEVICE_KEY_AT_CMD, //(8)

	AUDIO_DEVICE_SYS_START,
	AUDIO_DEVICE_LINE_IN = AUDIO_DEVICE_SYS_START, //(9)
	AUDIO_DEVICE_FM, //(10)

	AUDIO_DEVICE_MIC_TO_SPK,
	AUDIO_DEVICE_MP3,
	AUDIO_DEVICE_SYS_END = AUDIO_DEVICE_MP3, //(13)

	AUDIO_DEVICE_NUM = AUDIO_DEVICE_SYS_END //(13)
}; //Audio Device
