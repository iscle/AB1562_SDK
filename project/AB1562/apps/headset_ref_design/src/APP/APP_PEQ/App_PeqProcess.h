...
#ifndef _APP_PEQ_PROCESS_H_
#define _APP_PEQ_PROCESS_H_
...
void APP_PeqProc_SetIndex(U8 peq_path, U8 modeIndex);
...
void APP_PeqProc_UpdatePEQSaveDataStatus(U8 component);

void APP_Peq_Init(void);
