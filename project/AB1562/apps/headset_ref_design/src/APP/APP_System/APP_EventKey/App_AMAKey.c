...
* Functions prototype
**************************************************************************************************/
static U16 app_Ama_CheckKey(U16 keyCode);
static U16 app_Ama_CheckKeySpeechToggle(U16 keyCode);
static U16 app_Ama_CheckKeySpeechStart(U16 keyCode);
static U16 app_Ama_CheckKeySpeechStop(U16 keyCode);
...
{
	{app_Ama_CheckKeySpeechToggle},	//AMA_KEY_EVENT_KEY_SPEECH_TOGGLE
	{app_Ama_CheckKeySpeechStart}, //AMA_KEY_EVENT_KEY_SPEECH_START
	{app_Ama_CheckKeySpeechStop}, //AMA_KEY_EVENT_KEY_SPEECH_STOP
};
...
{
	#if 0 // original
	APP_AMA_CTL_STRU *pLinkInfo = APP_Ama_GetLinkInfo();

	if(pLinkInfo)
	{
		if(pLinkInfo->amaState == APP_AMA_STATE_CONNECTED)
			return keyCode;
	}
...
static U16 app_Ama_CheckKeySpeechToggle(U16 keyCode)
{
	return app_Ama_CheckKey(keyCode);
}
...
static BOOL app_AMA_SpeechStart(BD_ADDR_T *pBdAddr)
{
	...
	if(AMA_Target_StartSpeech(pBdAddr, &startSpeechParam))
	{
		return TRUE;
	}
...
static BOOL app_AMA_SpeechStop(BD_ADDR_T *pBdAddr)
{
	...
	if(AMA_Target_StopSpeech(pBdAddr))
	{
