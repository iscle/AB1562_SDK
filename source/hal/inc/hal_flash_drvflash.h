...
typedef struct {
    ...
    int32_t     (*NonBlockEraseBlock) (void);
    int32_t     (*CheckDeviceReady)   (void *DriveData);
    int32_t     (*SuspendErase)       (void *DriveData);
    int32_t     (*ResumeErase)        (void *DriveData);
    ...
    int32_t     (*IOCtrl)             (void *DriveData, uint32_t CtrlAction); // For device IO control
} NOR_MTD_Driver;
