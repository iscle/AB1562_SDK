...
UART_REGISTER_T *const g_uart_regbase[]    = {UART0, UART1};
/*VDMA_REGISTER_T *const g_vdma_regbase[HAL_UART_MAX][2] = {
                                                            {VDMA_RG_UART0_TX_BASE, VDMA_RG_UART0_RX_BASE},
                                                            {VDMA_RG_UART1_TX_BASE, VDMA_RG_UART1_RX_BASE} };*/

static const hal_nvic_irq_t g_uart_port_to_irq_num[HAL_UART_MAX] = {UART0_IRQn, UART1_IRQn};
